$(document).ready(function() {
    ...
    $(".allRooms").on('mouseenter', function() {
      ...
      thisRoom = $(this).attr('data-bs-content');
    ...
    $('#dd1').change(function() {
      ...
      if (optionName == "Room Select…") {
        ...
        var thisOptionsParentBlockandFloor = $('[data-bs-content="' + optionName + '"]').parent().parent().attr('id');
        ...
        var thisOptionsRoomName = $('[data-bs-content="' + optionName + '"]').attr('id');
    ...
    $("#land_status").fancyTable({
        ...
        /* On update like search and sort of table */                 
         console.log({ element:this });
            ...
            jQuery('.column6 .fa-heart').on('click',function(){
              jQuery(this).toggleClass('fa');
              jQuery(this).toggleClass('fa-solid');
            });
